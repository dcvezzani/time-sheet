class TimeSheet.Routers.TimeSheetEntriesRouter extends Backbone.Router
  ...
  newTimeSheetEntry: ->
    @view = new TimeSheet.Views.TimeSheetEntries.NewView(collection: @time_sheet_entries)
  ...
  edit: (id) ->
    ...
    @view = new TimeSheet.Views.TimeSheetEntries.EditView(model: time_sheet_entry)
    $("#time_sheet_entries").html(@view.render().el)
